...
class TestSchemaLoader:
    ...
    def test_get_enum_values(self):
        ...
        assert get_enum_values(schema, "sample_id") is None
...
class TestExcelGeneration:
    ...
    def test_generate_sample_template(self, tmp_path):
        schema_path = os.path.join(SCHEMAS_DIR, "sample.yaml")
        output_path = str(tmp_path / "sample_manifest.xlsx")
...
class TestValidator:
    ...
    def test_valid_sample_manifest(self, tmp_path):
